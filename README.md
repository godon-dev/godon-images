...
|-------|----------|------|---------|
| `godon-api` | Rust (Axum) | 8080 | REST API for managing systemtenders, credentials, targets, and steerwishes; reads of the causal map (connectome, curves, predictions) |
